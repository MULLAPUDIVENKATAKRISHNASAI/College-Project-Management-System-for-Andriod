...
public class HODregistration extends Activity implements OnClickListener{
    	...
    	if(ad==Register)
    	{
    		   ...
    		   Mobile.getText().toString().trim().length()==0)
    		{
    			...
    			return;
				  ...
				  Toast.makeText(HODregistration.this, "Enter 10 digits",Toast.LENGTH_LONG).show();
			  }
			...
			{
    		db.execSQL("INSERT INTO HOD VALUES('"+Name.getText()+"','"+Mobile.getText()+
    				   "','"+EmailId.getText()+"','"+Password.getText()+"');");
    		showMessage("Success", "HOD Registered Successfully");
    		clearText();
			  }
    	}
    }
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.hodregistration, menu);
		return true;
	}
