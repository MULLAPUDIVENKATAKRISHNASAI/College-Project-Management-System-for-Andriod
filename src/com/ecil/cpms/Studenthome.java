...
public class Studenthome extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		b1.setOnClickListener(new OnClickListener() {
			...
			Intent aa=new Intent(Studenthome.this,AddProject.class);
			startActivity(aa);
			}
		});
		b4.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
			Intent aa=new Intent(Studenthome.this,MainActivity.class);
			startActivity(aa);
			}
		});
		...
		b3.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Cursor c=db.rawQuery("SELECT * FROM Student WHERE EmailId='"+em.getText()+"'", null);
	    		if(c.getCount()==0)
	    		{
	    			showMessage("Error", "No records found");
	    			return;
