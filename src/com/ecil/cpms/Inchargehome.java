...
public class Inchargehome extends Activity {
	TextView em;
	SQLiteDatabase db;
	Button b2,b3,b4;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_inchargehome);
		...
		b4.setOnClickListener(new OnClickListener() {
			...
			Intent aa=new Intent(Inchargehome.this,MainActivity.class);
			startActivity(aa);
			}
		});
		...
		b3.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Cursor c=db.rawQuery("SELECT * FROM Incharge WHERE EmailId='"+em.getText()+"'", null);
	    		if(c.getCount()==0)
	    		{
	    			showMessage("Error", "No records found");
	    			return;
